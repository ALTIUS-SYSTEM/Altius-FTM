...
export function RouteConfig() {
  ...
  <Card title="Vehicles">{cfg.vehicles.map(v => <div key={v} className="visit-row"><span className="visit-name">{v}</span></div>)}<div className="info-box">Vehicle presets are stored in this browser.</div></Card></div>;
}
